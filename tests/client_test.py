...
from ceptic.managers.certificatemanager import CertificateConfiguration
import os
...
def test_client_creation_with_certs():
	...
	config_settings = CertificateConfiguration(
	...
	client_settings = create_client_settings(name="client_test")
	client = CepticClient(client_settings,config_settings)
