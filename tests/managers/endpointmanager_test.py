...
def test_server_get_endpoint_with_variables():
    ...
    var_endpoint_tests.append("<>/<>")
    var_endpoint_tests.append("tests/<>/<>")
    var_endpoint_tests.append("tests/<>/other/<>")
    var_endpoint_tests.append("<>/tests/variable0/<>")
    var_endpoint_tests.append("<>/<>/<>/<>/<>")
    var_endpoint_tests.append("<>/<>/<>/<>/<>/test")
...
def test_server_get_endpoint_invalid_query():
    ...
    for endpoint in invalid_endpoints:
        try:
            ...
            pytest.fail("Raised unexpected {} exception with message '{}' for endpoint: {}".format(type(e),str(e),endpoint))
        else:
            pytest.fail("Did NOT raise EndpointManagerException for endpoint: {}".format(endpoint))
