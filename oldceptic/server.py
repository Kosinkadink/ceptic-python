...
from oldceptic.common import CepticRequest, CepticResponse, CepticStatusCode
from oldceptic.common import command_settings
from oldceptic.endpointmanager import EndpointManager, EndpointManagerException
from oldceptic.certificatemanager import CertificateManager, CertificateManagerException, create_ssl_config
from oldceptic.streammanager import StreamManager, StreamException, StreamTotalDataSizeException
from oldceptic.encode import EncodeGetter, UnknownEncodingException
...
class CepticServer(object):
    ...
    def run_server(self, delay_time=0.1):
        ...
        if self.settings["verbose"]:
            print('oldceptic server started - version {} on port {}'.format(
